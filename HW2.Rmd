...
$$u((1,0,1|(1,0,0) = m(0_{1}) + m(0_{2}) + m(p^s_{3}) + v(m(0_{1}) - m(1_{1})) + v(m(p^s_{3})-mc(0_{3})$$
$$= 4(0) + p^s + 3[4(0)-4(1)]+p^s \\ = 2p^s -12$$
...
$$u(1,0,1|(0,1,0) = m(1_{1}) + m(1_{3})(-p^b + v(mc1(1) - mc1(0)) + v(m(-p^b_{3})-m(0_{3})$$
$$= 4(1)-p^b1+(4(1)-0)+3[-p^b-0] \\ = 8 - 4p^b \\ p^b = 4$$ 
