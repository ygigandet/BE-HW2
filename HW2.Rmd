...
d)
In a situation where alpha is close to 1, we assume that the market is full of naive consumer. In such sceneario, those consumers will not anticipate the shrouded market and thereby will not respond to a price cut. 


e)
In a situation where alpha is close to 0, a high quality firm will choose a simple product to offer as the client will rather chose such option than one w
