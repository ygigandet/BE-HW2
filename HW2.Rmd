...
If the social degree of complexity were to be equal to 0, this mean that the firm will be fully transparent over its based and add-on price. In the case of our printer sales, a naive consumer might decided to go an another printer due to the debias.  
