...
$$u((1,0,1|(1,0) = m(0_{1}) + m(0_{2}) + m(p^s_{3}) + v(m(0_{1}) - m(1_{1})) + v(m(p^s_{3})-mc(0_{3}) \\ = 4(0) + p^s + 3[4(0)-4(1)]+p^s \\ = 2p^s -12$$
$$u((1,0,0|(1,0)) =u((1,0,1|(1,0) \\ 4 = -12 + 2p^s \\ p^s = 8$$
...
if we imagine an price equilibrum such that
$p_{j} = p^*, \forall j\neq i$
Then the profit is 
$$\pi = (p+\hat{p})D(-p+p^*)$$
