...
Make the assumption that the probability that the price p is smaller than $p_{min}$ is $q_{min}$.

Hence, she expects to consume shoes and spend $p$ with probability $q_{min}$
