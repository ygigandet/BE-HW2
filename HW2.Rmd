...
Let's imagine a situation where the agent owns a mug and do not expect to sell it, his reference point will be $(r_1,r_2,r_3) = (1,0,0)$. On the other hand in a situation for an agent who neither owns nor wants to acquire a mugs while a reference point of $(r_1,r_2, r_3) = (0, 0, 0)$. We now can estimate at which compensation price $p^s$ our agent would be indifferent between exchanging her mug or not.

$$u((1,0,0)|(1,0,0)) = m_{c_1}(4)+m_{c_2}(0)+m_{c_3}(0) = 4$$
$$u((0,0,p^s)|(1,0,0)) = m_{c_1}(0) + m_{c_2}(0) + m_{c_3}(p^s) + v_{r_1}(0 - 1) + v_{r_3}(p^s -0)$$
$$u((0,0,1)|(1,0,0))  = p^s + 3[0 -4*1]+p^s \\ = 2p^s -12$$
...
$$u((1,0,1)|(0,1,0)) = m_{c_1}(1) + m_{c_2}(0) + m_{c_3}(1) + v_{r_1}(1 - 0) + v_{r_2}(0 - 1) + v_{r_3}(-p^b - 0)$$
$$u((1,0,1)|(0,1,0)) = 4 * 1 - p^b + (1-0) + 3(0-1) + 3[-p^b-0] \\ = 2 - 4p^b \\ p^b = 1/2$$ 
